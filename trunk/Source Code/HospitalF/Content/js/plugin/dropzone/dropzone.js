			...
			<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-0" data-widget-editbutton="false">
				...
				<div>
					...
					<div class="widget-body">
						...
						<form action="http://192.241.236.31/test4.smartadmin/ajax/upload.php" class="dropzone" id="mydropzone"></form>
...
<script type="text/javascript">
	...
	loadScript("js/plugin/dropzone/dropzone.min.html", startDropzone);
